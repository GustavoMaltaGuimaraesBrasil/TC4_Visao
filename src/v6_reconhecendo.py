"""
Script para detectar faces, reconhecer pessoas conhecidas e analisar emoções em vídeo.
Usa yolov8n-face.pt para detecção de faces, DeepFace para reconhecimento facial e análise de emoções.
Carrega rostos conhecidos de src/Entrada/conhecidos para fazer reconhecimento.
"""
...
def detectar_faces_emocoes_video(
    ...
    caminho_saida: caminho para o vídeo de saída (padrão: src/Saida/v6/video_detectado.mp4)
    ...
    if caminho_saida is None:
        ...
        pasta_saida = PROJECT_ROOT / "src" / "Saida" / "v6"
